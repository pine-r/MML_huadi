...
<script type="text/javascript">
	function add(img,good,price,id){
		var block=$("<dl class='dl1'><dt><a href='goods_info.jsp?goodsId="+id+"'><img style='width:240px;height:128px;' src='"+img+"'></img></a></dt><dd><a href='goods_info.jsp' id='"+id+"'>"+good+"</a><span class='price'>价格："+price+"</span></dd></dl>");
		var div=$(".main1");
		div.append(block);
	...
	<div id="top">
		<ul class="menu1">
			<li><a href="shouye.jsp" class="top_link"
				style="padding-right: 10px;">欢迎来到米米乐,</a></li>
			<li><a href="userInfo.jsp" class="top_link" id="user">xxxxxxx</a></li>
			<li><a class="top_link" id="del">注销</a></li>
		</ul>
		<ul class="menu2">
